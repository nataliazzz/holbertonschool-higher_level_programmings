...
class Rectangle:
    ...
    def width(self, value):
        """
        checks parameters and size of the Rectangle
        Args:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Compares biggest or equal area value between two Rectangles
        Args:
            rect_1 (Rectangle): first Rectangle to compare
            rect_2 (Rectangle): second Rectangle to compare
        Returns:
            Rectangle: biggest Rectangle, or `rect_1` if the
    ...
    def __str__(self):
        """
        string with the representation of the Rectangle.
        """
